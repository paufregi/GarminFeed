...
import paufregi.garminfeed.presentation.syncweight.SyncWeightActivity
...
class SyncWeightActivityTest {
    ...
    FIXME: android.os.FileUriExposedException: file:///data/user/0/paufregi.garminfeed/files/test.csv exposed beyond app through Intent.getData()
    @Test
